...
# Example usage
aodv = AODV()
aodv.update_routing_table('A', 'B', 'B', 0)
aodv.update_routing_table('A', 'C', 'C', 0)
aodv.update_routing_table('B', 'D', 'D', 1)
aodv.update_routing_table('C', 'D', 'B', 2)

# Display routing table of each node
aodv.visualize_routing_table()

# Visualize the network graph
aodv.visualize_network_graph()
